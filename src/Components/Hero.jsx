       ...
       <div className="flex items-center py-10 flex-wrap">
        ...
        <div className="flex flex-col gap-10 py-10">
            <div className="flex flex-col text-5xl">
                ...
                <div className="flex text-sm pt-3">Currently,I am a Software Engineer at <span className="flex items-center"><img src={fb} alt="fb" /><span className="text-blue-700">Facebook</span></span>.</div>
            </div>
